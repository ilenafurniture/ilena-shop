    ...
    <div class="konten">
        <div class="konten artikel">
            <div class="container mb-5">
                ...
                <div class="p-5 mx-5 show-ke-hide"
                    ...
                    <div class="d-flex justify-content-between">
                        ...
                        <div class="d-flex gap-2 align-items-center">
                            ...
                            <a href="/admin/editarticle/<?= $artikel['id'] ?>" class="btn btn-default-putih">Edit</a>
                            <button
                                onclick="triggerToast('Artikel <?= $artikel['judul'] ?> akan dihapus?', '/admin/deletearticle/<?= $artikel['id'] ?>')"
                                class="btn btn-default-putih">Hapus</button>
                            <?php } ?>
                        </div>
                    </div>
                ...
                if ($isi['tag'] == 'h2' || $isi['tag'] == 'h4' || $isi['tag'] == 'p') {
                    ...
                    echo '<' . $isi['tag'] . ' class="' . $isi['style'] . ' link" href="' . $isi['link'] . '">' . $isi['teks'] . '</' . $isi['tag'] . '>';
                } else if ($isi['tag'] == 'img') {
            ...
            ?>
                ...
                <div class="p-4 mx-4 hide-ke-show-block"
                    ...
                    <div class="d-flex justify-content-between mb-1 align-items-center">
                        ...
                        <div class="d-flex gap-2 align-items-center">
                            ...
                            <?php if (session()->get('role') == 1) { ?>
                            <a href="/editarticle/<?= $artikel['id'] ?>" class="btn btn-default-putih">Edit</a>
                            <?php } ?>
                        </div>
                    </div>
                    <h1 class="judul"><?= $artikel['judul'] ?></h1>
            ...
            <div class="container">
                ...
                <div class="mx-auto mt-2" style="width: fit-content;">
                    <a href="/product" class="btn mx-auto btn-default-putih" style="width: fit-content;">Lihat Semua
                        Produk</a>
                </div>
            </div>
        </div>
