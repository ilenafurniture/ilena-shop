...
<div class="container d-flex justify-content-center">
    <div class="konten">
        ...
        <p>Ilena Furniture selalu mengedepankan kepercayaan yang telah pelanggan berikan dengan cara menjaga
            ...
            bentuk data atau informasi pribadi pengguna dari situs website Ilena Furniture.
        </p>
        <p>Untuk menghindari perbedaan persepsi, diharapkan membaca dan memahami kebijakan privasi dari awal hingga akhir.
            Setiap informasi yang Kami peroleh ketika proses pemesanan, akan digunakan secara sah sesuai dengan
            Undang-Undang Konsumen No. 8 Tahun 1999. Situs Ilena Furniture tidak akan mengungkap atau menyampaikan
        ...
        <p>Dengan senang hati Kami menerima segala kritik dan saran yang membangun dari para pelanggan sebagai bentuk
            ...
            yang Kami berikan kepada pelanggan.</p>
        <div class="d-flex">
            <div style="width: 100px;">
                <p class="m-0">Email</p>
            </div>
        ...
        <ul>
            <li>
                <p class="m-0">Pengiriman dalam dan luar kota dengan armada profesional mitra Kami</p>
            </li>
            <li>
        ...
        <p>Produk yang telah dibayarkan akan segera diproses dan dikirimkan sesegera mungkin dengan estimasi waktu H+1 pada hari kerja.
            Kepuasaan pelanggan adalah prioritas Kami, oleh karena itu Kami bekerjasama dengan partner logistik yang handal dan sudah
            cukup terkenal di Indonesia untuk mengantarkan produk yang Anda beli menuju ke tempat tujuan dengan aman dan tepat waktu.</p>
        <p>Ketentuan tarif biaya pengiriman mengikuti kebijakan masing - masing pihak logistik selaku mitra Kami.</p>

        <h6>Waktu Pengiriman</h6>
        <p>Pengaturan waktu pengiriman produk pesanan Anda akan disesuaikan dengan lokasi tujuan. Agar tidak terjadi kesalahan lokasi
            tujuan, Kami akan melakukan konfirmasi kepada nomor WhatsApp atau email yang tertera pada data yang pelanggan berikan pada
            Kami. Jika pelanggan tidak berada di rumah, mohon informasikan kepada tim customer service Kami, agar Kami dapat mengatur
            ulang jadwal pengiriman produk. Jika Anda berkenan, Anda juga bisa menginformasikan kepada Kami nama pihak yang Anda percaya
            untuk menerima pesanan Anda tersebut. Hal ini sebenarnya tidak Kami rekomendasikan mengingat bahwa Anda diharuskan melakukan
            pengecekan pada saat penerimaan produk.</p>
        <p>Setelah petugas logistik menurunkan produk yang Anda pesan, petugas logistik akan meminta Anda untuk mengisi sebuah formulir
            guna memastikan kondisi produk yang diterima dalam keadaan sempurna. Jika ada kerusakkan atau produk tidak sesuai dengan
            pesanan pelanggan, mohon untuk menghubungi customer service Kami agar dapat ditindaklanjuti dengan segera.</p>

        <h6>Status Pengiriman</h6>
        <p>Kami akan memberitahukan status dan nomor resi pengiriman pesanan sehingga Anda dapat mengetahui informasi terkini dari
            produk yang Anda pesan menggunakan tracking system dari mitra logistik Kami. Apabila Anda tidak menerima email dari Kami
            setelah melakukan pelunasan pembayaran, maka Anda bisa menghubungi customer service Kami.</p>

        <h6>Pengembalian</h6>
        <p>Apabila terdapat kerusakan pada bagian komponen/aksesoris yang Anda terima, harap untuk segera melakukan konfirmasi dengan
            Customer Service Kami untuk ditindaklanjuti sesuai dengan Standar Operasional Prosedur (SOP) yang berlaku.</p>
    </div>
</div>
<?= $this->endSection(); ?>