...
<div style="padding: 2em;">
    ...
    <div class="container-table">
        ...
        <?php foreach ($produk as $ind_p => $p) { ?>
            <div class="isi-table">
                <div style="flex: 1;"><img style="width: 50px; height: 50px; object-fit:cover;" id="img<?= $ind_p ?>" src="/viewpic/<?= $p['id']; ?>" alt=""></div>
                <div style="flex: 2;" class="d-flex flex-column align-items-start justify-content-center">
                    <p class="fw-bold m-0" style="font-size: 15px;"><?= $p['nama']; ?></p>
                    <p class="m-0" style="color: grey; font-size: 15px;">#1234<?= $p['id']; ?></p>
                </div>
