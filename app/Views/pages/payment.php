...
<form action="/actionpaycore/<?= $indexAddress; ?>" method="post">
    <div class="container konten baris-ke-kolom">
        <div style="flex:1;">
            <h5 style="letter-spacing: -1px; font-weight:100;" class="path"><a href="/address"
                    class="me-3 text-secondary" style="text-decoration: none;">Alamat</a> >
                ...
                <div class="container-pembayaran mb-1">
                        ...
                        <div class="container-pembayaran mb-1">
                            ...
                            radioPembayaranElm.forEach(elm => {
                                elm.addEventListener('change', (e) => {
                                    ...
                                    const containerFormCCElm = document.getElementById(
                                        'container-form-cc')
                    ...
                    <div class="pt-3 border-top d-none" id="container-form-cc">
                        ...
                        <div class="form-floating mb-1">
                            <input type="number" class="form-control d-block" placeholder="ccNumber" name="ccNumber"
                                id="floatingInput1">
                            <label for="floatingInput1">Card Number</label>
                        </div>
                        <div class="form-floating mb-1">
                            <input type="number" class="form-control d-block" placeholder="ccCvv" name="ccCvv"
                                id="floatingInput2">
                        ...
                        <div class="d-flex gap-1 w-100">
                            ...
                            <div class="form-floating mb-1">
                                <input type="number" class="form-control d-block" placeholder="ccCvv" name="ccYear"
                                    id="floatingInput4">
        ...
        <div class="tigapuluh-ke-seratus">
            ...
            <div class="card p-4">
                ...
                <div class="d-flex justify-content-between py-1">
                    ...
                    <p class="fw-bold m-0">
                        Rp
                        <?= number_format(($voucher['selected'] ? $hargaTotal + 5000 - $flashSale - $voucher['selected']['rupiah'] : $hargaTotal + 5000 - $flashSale), 0, ',', '.'); ?>
                    </p>
                </div>
