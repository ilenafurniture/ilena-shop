            ...
            <div class="container-pembayaran mb-1">
                ...
                <div class="collapse py-2 show" id="collapseExample4">
                    <div class="container-pembayaran">
                        <?php foreach ($listPaymentMethod as $key => $l) { ?>
                        <a href="/payment/method/<?= $l  ?>/<?= $indexAddress; ?>"
                            class="item-logo-pembayaran <?= ($l == $paymentMethod) ? 'active' : '' ?>">
                            <img src="/img/pembayaran/<?= $l ?>.webp" alt="<?= $l; ?>">
                        </a>
                        <?php } ?>
                    </div>
                </div>
...
function bayar(e) {
    ...
    window.location.href = "/actionpaycore/" + btoa(timeStamp + ":" +
        "<?= $indexAddress; ?>");
}
// function bayar(e) {
