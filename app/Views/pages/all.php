                ...
                switch ($_GET['jenis']) {
                    ...
                    case 'coffee-table': ?>
                        ...
                        <div class="container">
                            <div class="my-3 container-meta">
                                ...
                                <p class="text-justify">Apabila menyebut kata “coffee table” maka yang pertama terbesit adalah meja untuk meletakkan cangkir kopi. Meskipun tidak salah, akan tetapi coffee table memiliki fungsi yang lebih daripada hanya sebagai tempat meletakkan kopi saja. Pada dasarnya, meja ini biasa ditempatkan di area ruang tamu sehingga bisa disebut juga sebagai meja tamu, meja sofa, meja tatami, meja lounge, living room table, tea table dan masih banyak lagi sebutan lainnya.</p>
                                <p class="text-justify">Center table pada umumnya digunakan untuk menambahkan rasa nyaman saat duduk di sofa untuk menunggu sesuatu atau bercengkrama dengan keluarga, sahabat, hingga kolega. Di meja lounge ini bisa juga untuk meletakkan barang selain kopi seperti camilan, buku, remote TV, vas bunga, dan aksesoris lainnya.</p>
                                <h5>Tips Memilih Meja Kopi yang Tetap dengan Kebutuhan</h5>
                                <p class="text-justify">Karena fungsinya yang mengedepankan kenyamanan, maka beberapa hal ini perlu dipertimbangkan agar mendapatkan ukuran dan desain meja lounge yang sesuai dengan kebutuhan.</p>
                                <ol>
                                    <li>Pilih Meja Tamu Sesuai dengan Fungsinya</li>
                                    <p class="text-justify mb-1">Meja kopi bukan hanya sebagai tempat meletakkan minuman atau makanan ringan, tetapi juga bisa berfungsi lebih dari itu. Jika kamu sering menerima tamu, pilih meja dengan permukaan yang cukup luas agar nyaman digunakan. Jika ingin yang lebih praktis, pilih living room table dengan rak tambahan di bawahnya untuk menyimpan majalah, buku, atau remote TV. Bagi yang memiliki ruang tamu minimalis, center table multifungsi dengan laci atau desain lipat bisa menjadi pilihan terbaik.</p>
                                    <li>Perhatikan Ukuran dan Dimensi Meja</li>
                                    <p class="text-justify mb-1">Jangan sampai center table yang dipilih malah membuat ruang tamu terasa sempit atau tidak proporsional. Pastikan ukurannya sesuai dengan luas ruangan dan tinggi sofa agar nyaman digunakan. Sebagai patokan umum, meja tatami idealnya memiliki tinggi sekitar 40-50 cm dan panjang sekitar setengah atau dua pertiga dari panjang sofa. Jika ruang tamu kecil, pilih living room table dengan desain minimalis dan ukuran yang lebih compact agar tidak mengganggu mobilitas.</p>
                                    <li>Selaraskan Bentuk dengan Luas Ruang Tamu</li>
                                    <p class="text-justify mb-1">Bentuk tea table juga harus disesuaikan dengan tata letak dan luas ruangan. Meja berbentuk persegi atau persegi panjang cocok untuk ruang tamu yang luas dan memiliki sofa panjang. Jika ruang tamu cukup kecil atau memiliki banyak perabot, meja berbentuk bundar atau oval bisa menjadi pilihan karena tidak memiliki sudut tajam dan lebih aman, terutama jika ada anak kecil di rumah.</p>
                                    <li>Pastikan Pilih yang Sesuai dengan Tema Ruangan</li>
                                    <p class="text-justify mb-1">Meja sofa yang selaras dengan tema ruangan akan membuat tampilan lebih harmonis dan estetis. Jika ruang tamu bergaya minimalis, pilih meja dengan desain simpel dan warna netral seperti putih, hitam, atau kayu alami. Untuk tema klasik atau vintage, meja tatami dengan material kayu solid dan ukiran detail bisa menjadi pilihan. Jika suka tampilan modern dan elegan, meja dengan kombinasi kaca dan logam bisa memberikan kesan mewah.</p>
                                </ol>
                                <h5>Beli Meja Kopi di Ilena Furniture</h5>
                                <p class="text-justify">Jika sedang berencana membeli furniture coffee table, Anda berada di tempat yang tepat! Karena di Ilena furniture Anda bisa menemukan berbagai model meja sofa dengan berbagai ukuran dan desain yang sesuai dengan selera. Mulai dari tea table dengan modern, minimalis, industrial, japandi, etnic, dan lain sebagainya.</p>
                                <p class="text-justify">Temukan berbagai produk pilihan dengan kualitas terbaik dengan harga yang terbaik pula. Makin hemat dengan gabung jadi member Ilena dan dapatkan penawaran khusus hanya untuk Anda!</p>
                            </div>
                        </div>
                        <div class=" d-flex justify-content-center mb-5">
                            <button class="btn btn-lonjong " onclick="openMeta(event)">Lihat selengkapnya</button>
                    ...
                    case 'console-table': ?>
                        ...
                        <div class="container">
                            <div class="my-3 container-meta">
                                <div class="overlay-meta"></div>
                                <p class="text-justify">Console table atau entryway table merupakan meja kecil yang biasanya akan dijumpai pada area dekat dinding serta menjadi bagian dari dekorasi ruangan. Tidak hanya sekedar digunakan untuk tempat penyimpanan saja, akan tetapi meletakkan meja konsol di ruangan bisa menaikkan value ruang menjadi lebih dari sebelumnya. Karena pada dasarnya setiap ruang berharga dengan fungsinya masing-masing, hall table mempertegas dengan look yang lebih bergengsi dari ruangan tersebut. Mulai dari ruang tamu, lorong, atau bahkan tempat tidur. Furniture entryway table ini bisa melebur dengan indah menjadi bagian dari dekorasi ruangan selain dari fungsinya sebagai penambah area penyimpanan saja.</p>
                                <h5>Tips Memilih Console Table</h5>
                                <p class="text-justify">Memilih sofa table yang tepat memerlukan perhatian terhadap beberapa aspek penting. Berikut adalah tips untuk mendapatkan hall table yang sesuai dengan gaya dan kebutuhan hunian.</p>
                                <ol>
                                    <li>Sesuaikan dengan Gaya Interior</li>
                                    <p class="text-justify mb-1">Meja foyer harus selaras dengan konsep interior rumah. Jika rumah bergaya klasik, pilih meja dengan ukiran detail dan material kayu berkualitas tinggi seperti mahoni atau jati. Untuk gaya modern minimalis, meja dengan desain simpel dan material yang tepat seperti kayu. Sementara itu, bagi yang menyukai estetika kontemporer, perpaduan material marmer dan besi bisa memberikan kesan eksklusif.</p>
                                    <li>Perhatikan Ukuran dan Proporsi</li>
                                    <p class="text-justify mb-1">Ukuran sofa table harus seimbang dengan ruangan tempatnya ditempatkan. Meja yang terlalu besar dapat membuat ruangan terasa sempit, sedangkan meja yang terlalu kecil bisa tampak tenggelam dalam dekorasi. Pastikan tinggi meja tidak melebihi 90 cm agar tetap proporsional dan nyaman digunakan.</p>
                                    <li>Pilih Material Berkualitas</li>
                                    <p class="text-justify mb-1">Kualitas material sangat menentukan daya tahan dan estetika accent table. Material seperti kayu solid ataupun engineering wood untuk memberikan kesan hangat dan klasik, sementara marmer memberikan tampilan mewah dan eksklusif. Jika menginginkan sentuhan industrial, accent table dengan kombinasi kayu dan besi bisa menjadi pilihan yang menarik.</p>
                                    <li>Fungsionalitas yang Optimal</li>
                                    <p class="text-justify mb-1">Selain sebagai elemen dekoratif, hall table juga bisa berfungsi sebagai tempat penyimpanan tambahan. Pilih meja dengan laci atau rak terbuka jika ingin menyimpan barang seperti kunci, buku, atau aksesoris dekoratif. Jika digunakan sebagai meja rias, pastikan ada ruang cukup untuk menempatkan cermin dan perlengkapan kecantikan.</p>
                                    <li>Warna dan Finishing yang Elegan</li>
                                    <p class="text-justify mb-1">Pemilihan warna dan finishing yang tepat akan memperkuat kesan mewah pada meja foyer. Warna netral seperti putih, hitam, atau abu-abu memberikan kesan modern dan elegan. Sementara itu, finishing glossy atau matte bisa dipilih sesuai preferensi pribadi untuk menyesuaikan dengan keseluruhan tampilan ruangan.</p>
                                    <li>Tambahan Dekorasi Yang Selaras</li>
                                    <p class="text-justify mb-1">Untuk mempercantik tampilan sofa table, tambahkan dekorasi yang sesuai seperti vas bunga, lampu meja, atau cermin dinding. Pastikan elemen dekoratif ini tetap proporsional dan tidak mengganggu fungsi utama meja foyer tersebut.</p>
                                </ol>
                                <h5>Beli Console Table Terpercaya dan Terjamin Kualitasnya</h5>
                                <p class="text-justify">Apabila sedang mencari referensi produk accent table dengan desain dan material yang berkualitas dan sudah teruji di pasar internasional, Ilena furniture adalah pilihan tepat! Hanya dibuat dari bahan berkualitas yang sudah teruji dan ramah lingkungan. Desain yang dibuat merupakan mahakarya yang diperuntukkan untuk menyempurnakan keindahan interior ruangan Anda.</p>
                                <p class="text-justify">Dapatkan untung lebih seru dengan join member Ilena dan klaim berbagai kesempatan berharga dalam berbelanja hanya dengan melakukan pembelian di website Ilena Furniture.</p>
                                <p class="text-justify">Lihat produk entryway table dan cari yang sesuai dengan tema serta preferensi masing-masing. Karena kami percaya, setiap ruang melambangkan suatu identitas dari pemilik ruangan tersebut.</p>
                    ...
                    case 'meja-nakas': ?>
                        ...
                        <div class="container">
                            <div class="my-3 container-meta">
                                ...
                                <p class="text-justify">Meja nakas atau yang dikenal juga sebagai side table adalah salah satu furniture yang biasanya diletakkan pada samping tempat tidur. Meja ini memiliki banyak fungsi seperti meletakkan barang-barang kecil yang diperlukan sebelum tidur, hingga aksesoris tambahan untuk percantik kamar. Beberapa hal yang harus diperhatikan saat memilih nakas minimalis:</p>
                                <ol>
                                    <li>Ukuran meja</li>
                                    <p class="text-justify mb-1">Side table biasanya tersedia dalam ukuran kecil dan sederhana supaya bisa hemat tempat</p>
                                    <li>Tinggi meja</li>
                                    <p class="text-justify mb-1">Pada umumnya tinggi end table berkisar dengan ketinggian kasur. Hal ini ditujukan agar saat menaruh dan menyimpan barang di nightstand table, dapat dengan mudah dalam jangkauan tangan saat sedang di atas tempat tidur.</p>
                                    <li>Bentuk</li>
                                    <p class="text-justify mb-1">Model meja ini sangatlah beragam walaupun ukurannya yang cukup ramping. Mulai dari persegi panjang, bulat, ataupun persegi.</p>
                                    <li>Material pembuatan</li>
                                    <p class="text-justify mb-1">Bahan yang umumnya digunakan untuk membuat nakas minimalis ini bisa berasal dari bahan kayu, metal, kaca, plastik, maupun kombinasi.</p>
                                </ol>
                                <h5>Dimana Meja Nakas dapat Difungsikan?</h5>
                                <p class="text-justify">Secara mudahnya, end table merupakan salah satu furniture simpel yang bisa dimanfaatkan di berbagai ruangan sesuai dengan kebutuhan. Berikut ini rekomendasi ruangan yang cocok dijadikan tempat menaruh furniture ini:</p>
                                <ol>
                                    <li>Kamar Tidur</li>
                                    <p class="text-justify mb-1">Bedside table dengan permukaan atau top table yang mudah dijangkau saat menyimpan barang menjadikan nightstand cocok diletakkan pada samping tempat tidur. Barang-barang seperti buku, kacamata, handphone, air minum, atau lainnya bisa dengan mudah diambil jika barang-barang tersebut berada di jangkauan tangan. Selain itu bedside table juga bisa dijadikan tempat menaruh lampu tidur untuk pencahayaan tambahan Tak hanya itu saja, aksesoris seperti frame foto,jam alarm, vas bunga atau tanaman kecil juga bisa diletakkan pada meja ini.</p>
                                    <li>Ruang Tamu</li>
                                    <p class="text-justify mb-1">Bedside table juga bisa jadi opsi terbaik untuk diletakkan pada ruang tamu sebagai tempat bersantai. Meja ini bisa digunakkan meletakkan minuman atau camilan supaya mudah dijangkau. Tak hanya itu, juga bisa untuk menaruh remot TV, remot AC, majalah, atau koleksi buku di side table. Selain menampilkan kesan rapi, nightstand ini juga bisa dijadikan space untuk menambah estetika dalam ruangan.</p>
                                    <li>Ruang Kerja</li>
                                    <p class="text-justify mb-1">Lamp table bisa juga dijadikan tempat untuk menyimpan banyak barang yang menunjang pekerjaan atau sekolah. Mulai dari alat tulis, catatan, alat tulis, atau koleksi buku yang sering digunakan saat bekerja. Penambahan lampu belajar di lamp table juga bisa jadi ide yang bagus untuk meningkatkan produktivitas kerja sehingga pekerjaan dapat selesai lebih cepat. </p>
                                    <li>Dapur</li>
                                    <p class="text-justify mb-1">Sekilas mungkin terdengar agak aneh, tapi jika berani untuk menambah nakas minimalis ini mencoba maka akan timbul suasana yang berbeda dan lebih segar di mata. Jadi tidak hanya menambah tempat penyimpanan barang saja, tapi lamp table ini bisa pula menambah kesan estetika pada ruang dapur.</p>
                                </ol>
                                <h5>Cari Meja Nakas di Ilena Furniture</h5>
                                <p class="text-justify">Apabila Anda sedang mencari referensi model end table dengan gaya modern dan minimalis terbaru. Terbuat dari bahan premium pilihan berupa engineering wood maupun metal yang awet lama sehingga cocok untuk penggunaan lama. Anda bisa memilih berbagai suasana mulai dari modern, minimalis, industrial, japandi, dan berbagai tema ruangan lainnya yang bisa dipadukan dengan furniture dari Ilena. Dibandrol dengan kisaran harga yang cukup terjangkau sehingga sangat worth it untuk pembelian dalam jumlah banyak.</p>
                                <p class="text-justify">Jadilah bagian dari teman Ilena dan dapatkan berbagai keuntungan membership yang tersedia terbatas hanya untuk Anda.</p>
                            </div>
                        </div>
                        <div class=" d-flex justify-content-center mb-5">
                            <button class="btn btn-lonjong " onclick="openMeta(event)">Lihat selengkapnya</button>
