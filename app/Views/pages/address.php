...
<div class="container konten baris-ke-kolom">
    <div style="flex:1;">
        ...
        <button type="button" class="btn-teks-aja" data-bs-toggle="modal" data-bs-target="#exampleModal"><i class="material-icons">add</i> Tambah Alamat Penerima</button>
    ...
    <div class="tigapuluh-ke-seratus">
        <div class="card p-4">
            ...
            <a id="btn-shipping" <?= count($alamat) > 0 ? 'href="/payment/0"' : '' ?> class="btn-default-merah <?= count($alamat) > 0 ? '' : 'disabled' ?> w-100 mt-4 text-center">Pilih
