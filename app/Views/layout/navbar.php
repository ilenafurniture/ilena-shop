...
<div class="justify-content-center w-100 show-flex-ke-hide"
    ...
    <div class="d-flex align-items-center py-2 gap-5">
            ...
            <div class="child-list-nav">
                <div class="container py-3 d-flex">
                    <div style="flex: 1;">
                        ...
                        <a class="w-100 d-block" style="text-decoration: none; font-weight:500;"
                    ...
                    <div style="flex: 3" class="mt-4">
                        <a class="w-100 d-block" style="text-decoration: none; font-weight:500;"
                            href="/product?koleksi=sorely&jenis=tv-media">Bufet TV</a>
                        <a class="w-100 d-block" style="text-decoration: none; font-weight:500;"
                ...
                <div class="container py-3 d-flex">
                    <div style="flex: 1">
                        ...
                        <a class="w-100 d-block" style="text-decoration: none; font-weight:500;"
                            ...
                            Drawer</a>
                        <!-- <a class="w-100 d-block" style="text-decoration: none; font-weight:500;"
                            href="/product?koleksi=cabana&jenis=dresser-6-drawer">Dresser Tall
                            Cabinet
                        </a> -->
                        <!-- <a class="w-100 d-block" style="text-decoration: none; font-weight:500;"
                    ...
                    <div style="flex: 3" class="mt-4">
                        <a class="w-100 d-block" style="text-decoration: none; font-weight:500;"
                            href="/product?koleksi=cabana&jenis=tv-media">Bufet TV</a>
                        <!-- <a class="w-100 d-block" style="text-decoration: none; font-weight:500;"
                        ...
                        <a class="w-100 d-block" style="text-decoration: none; font-weight:500;"
                            ...
                            Table</a>
                        <!-- <a class="w-100 d-block" style="text-decoration: none; font-weight:500;"
                            href="/product?koleksi=cabana&jenis=single-bed">Single Bed
                            Cabana</a> -->
                    </div>
                    <div style="width: 233px">
            ...
            <div class="child-list-nav">
                <div class="container py-3 d-flex">
                    <div style="flex: 1;">
                        ...
                        <a class="w-100 d-block" style="text-decoration: none; font-weight:500;"
                            href="/product?koleksi=orca&jenis=coffee-table">Coffee
                            Table</a>
                        <!-- <a class="w-100 d-block" style="text-decoration: none; font-weight:500;"
                        ...
                        <!-- <a class="w-100 d-block" style="text-decoration: none; font-weight:500;"
                            href="/product?koleksi=orca&jenis=dresser-3-drawer">Dresser
                            3
                            Drawer</a> -->
                        <!-- <a class="w-100 d-block" style="text-decoration: none; font-weight:500;"
                            href="/product?koleksi=orca&jenis=dresser-5-drawer">Dresser
                            5
                            Drawer</a> -->
                        <a class="w-100 d-block" style="text-decoration: none; font-weight:500;"
                            href="/product?koleksi=orca&jenis=dresser-6-drawer">Dresser
                            6
                            Drawer</a>
                        <!-- <a class="w-100 d-block" style="text-decoration: none; font-weight:500;"
                            href="/product?koleksi=orca&jenis=dresser-6-drawer">Dresser
                    ...
                    <div style="flex: 3" class="mt-4">
                        <a class="w-100 d-block" style="text-decoration: none; font-weight:500;"
                            href="/product?koleksi=orca&jenis=tv-media">Bufet TV</a>
                        <!-- <a class="w-100 d-block" style="text-decoration: none; font-weight:500;"
                        ...
                        <a class="w-100 d-block" style="text-decoration: none; font-weight:500;"
                            ...
                            Table</a>
                        <!-- <a class="w-100 d-block" style="text-decoration: none; font-weight:500;"
                            href="/product?koleksi=orca&jenis=single-bed">Single Bed
                            Orca</a> -->
                    </div>
                    <div style="width: 233px">
                        <a href="#" class="container-produk-nav">
                            <img class="mb-3" src="/viewvar/10601401/4" alt="">
                            <h5>Side table</h5>
            ...
            <div class="child-list-nav">
                <div class="container py-3 d-flex">
                    <div style="flex: 1;">
                        ...
                        <a class="w-100 d-block" style="text-decoration: none; font-weight:500;"
                            href="/product?koleksi=water-case&jenis=coffee-table">Coffee
                            Table</a>
                        <a class="w-100 d-block" style="text-decoration: none; font-weight:500;"
                    ...
                    <div style="flex: 3" class="mt-4">
                        <a class="w-100 d-block" style="text-decoration: none; font-weight:500;"
                            href="/product?koleksi=water-case&jenis=tv-media">Bufet TV</a>
                        <!-- <a class="w-100 d-block" style="text-decoration: none; font-weight:500;"
                        ...
                        <a class="w-100 d-block" style="text-decoration: none; font-weight:500;"
                            ...
                            Table</a>
                        <!-- <a class="w-100 d-block" style="text-decoration: none; font-weight:500;"
                            href="/product?koleksi=water-case&jenis=single-bed">Single Bed
                            Water Case</a> -->
                    </div>
                    <div style="width: 233px">
                        <a href="#" class="container-produk-nav">
                            <img class="mb-3" src="/viewvar/11000901/2" alt="">
                            <h5>Lemari laci 6</h5>
            ...
            <div class="child-list-nav">
                <div class="container py-3 d-flex">
                    <div style="flex: 1;">
                        ...
                        <a class="w-100 d-block" style="text-decoration: none; font-weight:500;"
                            href="/product?koleksi=plint-base&jenis=coffee-table">Coffee
                            Table</a>
                        <a class="w-100 d-block" style="text-decoration: none; font-weight:500;"
                    ...
                    <div style="flex: 3" class="mt-4">
                        <a class="w-100 d-block" style="text-decoration: none; font-weight:500;"
                            href="/product?koleksi=plint-base&jenis=tv-media">Bufet TV</a>
                        <!-- <a class="w-100 d-block" style="text-decoration: none; font-weight:500;"
                        ...
                        <a class="w-100 d-block" style="text-decoration: none; font-weight:500;"
                            ...
                            Table</a>
                        <!-- <a class="w-100 d-block" style="text-decoration: none; font-weight:500;"
                            href="/product?koleksi=plint-base&jenis=single-bed">Single Bed
                            Plint base</a> -->
                    </div>
                    <div style="width: 233px">
                        <a href="#" class="container-produk-nav">
                            <img class="mb-3" src="/viewvar/10701402/1" alt="">
        ...
        <div class="list-nav">
            <a class="text-dark text-center w-100 d-block" style="text-decoration: none;"
                href="/product?koleksi=cutout">Cut Out</a>
            <div class="child-list-nav">
                <div class="container py-3 d-flex">
                    <div style="flex: 1;">
                        ...
                        <a class="w-100 d-block" style="text-decoration: none; font-weight:500;"
                            href="/product?koleksi=cut-out&jenis=coffee-table">Coffee
                            Table</a>
                        <!-- <a class="w-100 d-block" style="text-decoration: none; font-weight:500;"
                        ...
                        <!-- <a class="w-100 d-block" style="text-decoration: none; font-weight:500;"
                            href="/product?koleksi=cut-out&jenis=king-bed">King
                            Bed</a> -->
                    </div>
                    <div style="flex: 3" class="mt-4">
                        <a class="w-100 d-block" style="text-decoration: none; font-weight:500;"
                            href="/product?koleksi=cut-out&jenis=tv-media">Bufet TV</a>
                        <!-- <a class="w-100 d-block" style="text-decoration: none; font-weight:500;"
                            href="/product?koleksi=cut-out&jenis=queen-bed">Queen Bed</a> -->
                        <a class="w-100 d-block" style="text-decoration: none; font-weight:500;"
                            href="/product?koleksi=cut-out&jenis=side-table">Side
                            Table</a>
                        <!-- <a class="w-100 d-block" style="text-decoration: none; font-weight:500;"
                            href="/product?koleksi=cut-out&jenis=single-bed">Single Bed
                            Cut Out</a> -->
                    </div>
                    <div style="width: 233px">
                        <a href="#" class="container-produk-nav">
                            <img class="mb-3" src="/viewvar/10301601/1" alt="">
