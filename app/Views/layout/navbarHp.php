<div class="navbar-hp-atas hide-ke-show-flex">
    ...
    <div style="width: fit-content">
        <div class="">
            ...
            <div class="expend-hp">
                <p class="mb-2" style="color:white;">Collection
                </p>
                <div>
                    <label for="collection1" class="collectionjdl" style="color:white;">Sorely</label>
                ...
                <div>
                    <label for="collection2" class="collectionjdl" style="color:white;">Cabana</label>
                ...
                <div>
                    <label for="collection3" class="collectionjdl" style="color:white;">Orca</label>
                ...
                <div>
                    <label for="collection4" class="collectionjdl" style="color:white;">Water Case</label>
                ...
                <div>
                    <label for="collection5" class="collectionjdl" style="color:white;">Plint Base</label>
                ...
                <div>
                    <label for="collection6" class="collectionjdl" style="color:white;">Cut Out</label>
