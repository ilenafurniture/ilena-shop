...
<head>
    ...
    <meta property="og:image" content="<?= isset($metaImage) ? $metaImage : 'https://ilenafurniture.com/img/logo/N.png'; ?>">
    ...
    <?php } ?>
    <link rel="stylesheet" href="<?= base_url('css/style.css?v=22-04-2025'); ?>">
